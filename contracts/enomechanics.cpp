...
CONTRACT enomechanics : public enumivo::contract {
    public:
         ...
         */
        [[enumivo::action]] void net(std::string input) {
            // Only let us run this
            require_auth(_self);
        }
    ...
    private:
        ...
        typedef enumivo::multi_index<"ramdata"_n, ramdata> ramdata_index;

};

ENUMIVO_DISPATCH(enomechanics, (cpu)(ram)(net))
